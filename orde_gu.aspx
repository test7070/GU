		...
		<script type="text/javascript">
			...
			function mainPost() {
				...
				$('#btnOrde2ordc').click(function() {
					if (!emp($('#txtCustno').val())) {
						q_box("z_orde2ordc_gu.aspx?" + r_userno + ";" + r_name + ";" + q_time + ";noa='" + $('#txtNoa').val() + "';" + r_accy + ";" + q_cur, 'orde2ordc', "95%", "95%", $('#btnOrde2ordc').val());
					}
				});
			...
			function _btnSeek() {
				if (q_cur > 0 && q_cur < 4)
					return;
				q_box('orde_gu_s.aspx', q_name + '_s', "500px", "450px", q_getMsg("popSeek"));
			}
			...
			<div class='dbbm'>
				<table class="tbbm" id="tbbm" style="width: 1073px;" border="0">
					...
					<tr>
						...
						<td align="center"><input id="btnOrde2ordc" type="button" value='物料需求表' /></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input id="btnAddr2" type="button" value='...' style="width: 30px;height: 21px" /> <span> </span><a id='lblOrdcno' class="lbl"> </a></td>
