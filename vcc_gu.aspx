...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
	<head>
		...
		<script type="text/javascript">
			...
			aPop = new Array(
				['txtCustno', 'lblCust', 'cust', 'noa,comp,nick,tel,fax,zip_comp,addr_comp,paytype,trantype,salesno,sales', 'txtCustno,txtComp,txtNick,txtTel,txtFax,txtPost,txtAddr,txtPaytype,cmbTrantype,txtSalesno,txtSales', 'cust_b.aspx'],
			...
			function mainPost() {
				...
				bbsNum = [['txtPrice', 12, q_getPara('vcc.pricePrecision'), 1], ['txtMount', 15, q_getPara('vcc.mountPrecision'), 1]
				...
				$('#btnPack').click(function() {
                	...
                	if(t_noa.length > 0){
                		t_where = "noa='" + t_noa + "'";
                		q_box("packing_gu_b.aspx?" + r_userno + ";" + r_name + ";" + q_time + ";" + t_where, 'pack', "1080px", "95%", $('#btnPack').val());
                	}
				});
				$('#btnPack').val('Packing');
			...
			function btnPrint() {
				q_box('z_vccp_gu.aspx' + "?;;;noa=" + trim($('#txtNoa').val()) + ";" + r_accy, '', "95%", "95%", q_getMsg("popPrint"));
			}
			...
			<div class='dbbm'>
				<table class="tbbm" id="tbbm" style="width:990px;">
					...
					<tr> 
						...
						<td><input id="btnBoaj" type="button" style="float: right;"/></td>
					</tr>
					<tr>
			...
			<table id="tbbs" class='tbbs'>
				...
				<tr style='background:#cad3ff;'>
					<td>
						...
						<input id="txtNoq.*" type="hidden" class="txt c6"/>
					</td>
					<!--<td align="center">
